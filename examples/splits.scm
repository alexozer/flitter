((title "Super Monkey Ball 2: Monkeyed Ball")
 ...
 (world_record 
   (
    ...
    (splits 
      (
       ((title Green) (time 2:12) (is_gold false))
       ((title Apricot) (time 4:27) (is_gold false))
       ((title Blue) (time 6:28) (is_gold false))
       ((title Brown) (time 8:46) (is_gold false))
       ((title Pink) (time 10:59) (is_gold false))
       ((title White) (time 13:36) (is_gold false))
       ((title Teal) (time 16:00) (is_gold false))
       ((title Orange) (time 18:17) (is_gold false))
       ((title Gold) (time 20:31) (is_gold false))
       ((title Black) (time 24:16) (is_gold false))
       ))
    )
   )
