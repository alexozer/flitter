...
Copy an example splits file from the `examples` folder somewhere. Edit it and add your game and split information. Neither a personal best time nor gold segments are required.
